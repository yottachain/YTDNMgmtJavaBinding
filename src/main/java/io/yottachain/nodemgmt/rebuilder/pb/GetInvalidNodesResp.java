...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              shardCounts_ = new java.util.ArrayList<io.yottachain.nodemgmt.rebuilder.pb.ShardCountMsg>();
              mutable_bitField0_ |= 0x00000001;
            }
            shardCounts_.add(
                input.readMessage(io.yottachain.nodemgmt.rebuilder.pb.ShardCountMsg.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp)) {
      return super.equals(obj);
    }
    io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp other = (io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp) obj;
  ...
  public static io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp parseFrom(
  ...
  public static io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp parseFrom(
  ...
  public static io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp getDefaultInstanceForType() {
      return io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp.getDefaultInstance();
    }

    @java.lang.Override
    public io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp build() {
      io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp result = buildPartial();
    ...
    @java.lang.Override
    public io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp buildPartial() {
      io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp result = new io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp) {
        return mergeFrom((io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp)other);
      } else {
    ...
    public Builder mergeFrom(io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp other) {
      if (other == io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp.getDefaultInstance()) return this;
      if (shardCountsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp) e.getUnfinishedMessage();
    ...
    private void ensureShardCountsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        shardCounts_ = new java.util.ArrayList<io.yottachain.nodemgmt.rebuilder.pb.ShardCountMsg>(shardCounts_);
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        io.yottachain.nodemgmt.rebuilder.pb.ShardCountMsg, io.yottachain.nodemgmt.rebuilder.pb.ShardCountMsg.Builder, io.yottachain.nodemgmt.rebuilder.pb.ShardCountMsgOrBuilder> 
        getShardCountsFieldBuilder() {
      if (shardCountsBuilder_ == null) {
  ...
  public static io.yottachain.nodemgmt.rebuilder.pb.GetInvalidNodesResp getDefaultInstance() {
