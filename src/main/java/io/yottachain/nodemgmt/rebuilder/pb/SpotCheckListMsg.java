...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 18: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              taskList_ = new java.util.ArrayList<io.yottachain.nodemgmt.rebuilder.pb.SpotCheckTaskMsg>();
              mutable_bitField0_ |= 0x00000001;
            }
            taskList_.add(
                input.readMessage(io.yottachain.nodemgmt.rebuilder.pb.SpotCheckTaskMsg.parser(), extensionRegistry));
            break;
          }
          case 24: {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg)) {
      return super.equals(obj);
    }
    io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg other = (io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg) obj;
  ...
  public static io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg parseFrom(
  ...
  public static io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg parseFrom(
  ...
  public static io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg getDefaultInstanceForType() {
      return io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg.getDefaultInstance();
    }

    @java.lang.Override
    public io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg build() {
      io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg result = buildPartial();
    ...
    @java.lang.Override
    public io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg buildPartial() {
      io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg result = new io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg) {
        return mergeFrom((io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg)other);
      } else {
    ...
    public Builder mergeFrom(io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg other) {
      if (other == io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private void ensureTaskListIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        taskList_ = new java.util.ArrayList<io.yottachain.nodemgmt.rebuilder.pb.SpotCheckTaskMsg>(taskList_);
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        io.yottachain.nodemgmt.rebuilder.pb.SpotCheckTaskMsg, io.yottachain.nodemgmt.rebuilder.pb.SpotCheckTaskMsg.Builder, io.yottachain.nodemgmt.rebuilder.pb.SpotCheckTaskMsgOrBuilder> 
        getTaskListFieldBuilder() {
      if (taskListBuilder_ == null) {
  ...
  public static io.yottachain.nodemgmt.rebuilder.pb.SpotCheckListMsg getDefaultInstance() {
