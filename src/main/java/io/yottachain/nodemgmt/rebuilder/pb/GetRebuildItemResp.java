...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 10: {
            io.yottachain.nodemgmt.rebuilder.pb.NodeMsg.Builder subBuilder = null;
            if (node_ != null) {
              subBuilder = node_.toBuilder();
            }
            node_ = input.readMessage(io.yottachain.nodemgmt.rebuilder.pb.NodeMsg.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp)) {
      return super.equals(obj);
    }
    io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp other = (io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp) obj;
  ...
  public static io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp parseFrom(
  ...
  public static io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp parseFrom(
  ...
  public static io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp getDefaultInstanceForType() {
      return io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp.getDefaultInstance();
    }

    @java.lang.Override
    public io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp build() {
      io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp result = buildPartial();
    ...
    @java.lang.Override
    public io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp buildPartial() {
      io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp result = new io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp) {
        return mergeFrom((io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp)other);
      } else {
    ...
    public Builder mergeFrom(io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp other) {
      if (other == io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp.getDefaultInstance()) return this;
      if (other.hasNode()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp) e.getUnfinishedMessage();
    ...
    public Builder mergeNode(io.yottachain.nodemgmt.rebuilder.pb.NodeMsg value) {
      if (nodeBuilder_ == null) {
        if (node_ != null) {
          node_ =
            io.yottachain.nodemgmt.rebuilder.pb.NodeMsg.newBuilder(node_).mergeFrom(value).buildPartial();
        } else {
          node_ = value;
        }
        onChanged();
    ...
    public io.yottachain.nodemgmt.rebuilder.pb.NodeMsgOrBuilder getNodeOrBuilder() {
      if (nodeBuilder_ != null) {
        ...
        return node_ == null ?
            io.yottachain.nodemgmt.rebuilder.pb.NodeMsg.getDefaultInstance() : node_;
      }
    }
    /**
     * <code>.pbrebuilder.NodeMsg node = 1;</code>
  ...
  public static io.yottachain.nodemgmt.rebuilder.pb.GetRebuildItemResp getDefaultInstance() {
