...
public final class YTDNMgmtGrpc {
    ...
    private static final int METHODID_NEW_NODE_ID = 0;
    private static final int METHODID_PRE_REGISTER_NODE = 1;
    private static final int METHODID_CHANGE_MINER_POOL = 2;
    private static final int METHODID_REGISTER_NODE = 3;
